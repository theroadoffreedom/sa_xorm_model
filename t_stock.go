...
type TStock struct {
	...
	CurrentPrice             string `json:"current_price" xorm:"DECIMAL(10,2)"`
	High52wPrice             string `json:"high52w_price" xorm:"DECIMAL(10,2)"`
	Low52wPrice              string `json:"low52w_price" xorm:"DECIMAL(10,2)"`
